...
# CUDA_VISIBLE_DEVICES=0 python pytorch/train.py train --config_path="configs/onestage/ori_server_50e.fhd.onestage copy.config" --model_dir="logs/lidaronly_test_11" --use_fusion False

CUDA_VISIBLE_DEVICES=2 python pytorch/train.py train --config_path="configs/onestage/autocal_server_fusion_50e.fhd.onestage.config" --model_dir="logs/alpha_test" --use_fusion False
